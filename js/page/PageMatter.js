js.page.PageMatter = function () {
    ...
    this.onCreate = function(parent){
        ...
        var listData = $jsmvc$.facade.reqModel("js.model.BotanyList").getList();
        for(var i=0;i<listData.length;i++){
            ...
            newItem.on("click",function(){
                ...
                protected.dataList.push({
                    ...
                    data:$jsmvc$.facade.reqModel("js.model.BotanyList").getByName($(this).attr("id"))
                });
    ...
    this.showPage = function(){
        ...
        protected.btn1.removeClass("btnFocus");
        protected.btn2.addClass("btnFocus");
    }

 ...
 * @example
 * 在 js/page 目录中新建一个 HelloWorld 类，并在 html 目录中添加一个 list.html 模版，内容可以是任意 html 标签
 ...
 *          //设置 HTML 模版，需要确保 html 目录下有 list.html 模版文件（名字区分大小写）
...
$jsmvc$.core.PageAbs = function (className) {
     ...
     *          //保存父类保护函数集合到一个私有变量中
     *          protected = parent;
     *          //需要确保 html 目录下有 list.html 模版文件（名字区分大小写）
     *          //模版路径用 . 符号隔开，并且不要有 .html 的后缀
